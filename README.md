...
- 飞行模式启动、阅读、翻页和本地进度恢复
- 左滑或点击正文右侧 40% 进入下一页，右滑或点击正文左侧 40% 返回上一页；点击中央 20% 唤起阅读菜单
...
- 手机底部阅读菜单提供字号调整、单本`电脑进度 → 手机`或`手机进度 → 电脑`，以及可高亮当前章节并跳转的单层目录
...
4. 阅读时使用左右滑动或正文左右 40% 区域短按翻页；点击中央 20% 打开底部菜单，选择字体、同步或目录。
